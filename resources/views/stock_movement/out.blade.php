...
<div class="container">
  <h3 style="border-bottom: 1px solid #000;border-left: 10px solid #000;padding: 7px;margin-top:10px;">出庫登録</h3>
  ...
  <form action="{{route('stock_out_store')}}" method="POST">
    @csrf
    <table class="table table_border_radius">
      <thead>
        <tr>
          <th colspan="2">出庫情報入力</th>
        </tr>
      </thead>
      <tbody>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <small class="text-muted">※利用可能在庫数の範囲内で指定してください</small>
          </td>
        </tr>
        <tr>
          <th>ロット番号</th>
        ...
        <tr>
          <th>出庫日時 <span class="text-danger">*</span></th>
          <td>
      ...
      <tfoot>
        <tr>
          <th colspan="2" class="t_foot">
            <button type="submit" class="btn btn-danger"><i class="fas fa-arrow-up"></i> 出庫登録</button>
